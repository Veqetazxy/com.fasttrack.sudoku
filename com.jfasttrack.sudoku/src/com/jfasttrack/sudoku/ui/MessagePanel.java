...
/**
 * The <code>MessagePanel</code> is a panel containing a text field. It displays various messages
 * for the user.
 *
 * @author   Pete Boton
 * @version  2009/05
...
public class MessagePanel extends JPanel {
    ...
    /** Constructs a <code>MessagePanel</code>. */
    public MessagePanel() {
        super(new FlowLayout(FlowLayout.LEFT, 0, 0));

        setBorder(BorderFactory.createBevelBorder(BevelBorder.LOWERED));
        add(statusLabel);
        statusLabel.setText(MessageBundle.getInstance().getString("welcome"));
    }

//TODO: Offer color selections, maybe red for error messages, etc.
